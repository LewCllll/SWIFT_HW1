...
/*:
 ...
 2. A function which returns the total price of books to purchase
...
func distinctAuthors() -> Set<String> {
    ...
    for booksCount in 0..<books.count{
        var orderOfBooks = books[booksCount]
        authors.insert(orderOfBooks["author"]!)
    }
    return authors
}
...
func totalBookPrice() -> Double {
    ...
    for booksCount in 0..<books.count{
        var orderOfBooks = books[booksCount]
        var price = Double(orderOfBooks["price"]!)
...
func getBook(at index: Int) -> (title: String, author: String, price: Double)? {
    ...
    var orderOfBooks = books[index]
    let title = orderOfBooks["title"]
    let author = orderOfBooks["author"]
    let price = Double(orderOfBooks["price"]!)
